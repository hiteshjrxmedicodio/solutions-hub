...
export function ModalContainer({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center" role="dialog" aria-modal="true">
      ...
      />
      <div
        className={`relative z-10 bg-white rounded-xl shadow-2xl w-full ${maxWidth} max-h-[90vh] overflow-hidden flex flex-col m-4 animate-in fade-in-50 slide-in-from-bottom-4 duration-300`}
