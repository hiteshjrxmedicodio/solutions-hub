...
export const Step4ContactInfo = ({ formData, updateNestedField, errors = {}, touchedFields = new Set() }: BuyerStepProps) => {
          ...
          <div className="px-6 pt-6 pb-4 border-b border-zinc-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-600 mt-0.5">Main point of contact for inquiries</p>
              </div>
            </div>
          </div>
