...
export async function GET(request: NextRequest) {
  try {
    ...
    await connectDB();
    // Find vendor with userId = "seed-medicodio" (database stores it as seed-medicodio)
    // This endpoint allows accessing it via /vendor/medicodio
    ...
    console.error("Error fetching medicodio vendor profile:", error);
    return NextResponse.json(
      {
        success: false,
