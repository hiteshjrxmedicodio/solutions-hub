  ...
  return (
    <section aria-labelledby="requirements-heading">
      <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-4">
        <h2 id="requirements-heading" className="text-base font-bold text-zinc-900 mb-3">
          Requirements
        </h2>
        ...
        <div className="flex gap-3">
          ...
          <div className="flex-1 space-y-3">
            {listing.requiredFeatures.length > 0 && (
              <div className="bg-zinc-50 rounded-lg border border-zinc-200 p-3">
                <h3 className="text-sm font-semibold text-zinc-800 mb-2">Required Features</h3>
                <ul className="list-disc list-inside text-zinc-700 space-y-0.5 text-xs" role="list">
                  {listing.requiredFeatures.map((feature, idx) => (
                    <li key={getItemKey(feature, idx)}>
                      {feature}
                    </li>
                  ))}
                </ul>
            ...
            {listing.preferredFeatures.length > 0 && (
              <div className="bg-zinc-50 rounded-lg border border-zinc-200 p-3">
                <h3 className="text-sm font-semibold text-zinc-800 mb-2">Preferred Features</h3>
                <ul className="list-disc list-inside text-zinc-700 space-y-0.5 text-xs" role="list">
            ...
            {listing.technicalRequirements.length > 0 && (
              <div className="bg-zinc-50 rounded-lg border border-zinc-200 p-3">
                <h3 className="text-sm font-semibold text-zinc-800 mb-2">Technical Requirements</h3>
                <ul className="list-disc list-inside text-zinc-700 space-y-0.5 text-xs" role="list">
                  {listing.technicalRequirements.map((req, idx) => (
                    <li key={getItemKey(req, idx)}>
                      {req}
                    </li>
                  ))}
                </ul>
          ...
          <div className="flex-1 space-y-3">
            {listing.integrationRequirements.length > 0 && (
              <div className="bg-zinc-50 rounded-lg border border-zinc-200 p-3">
                <h3 className="text-sm font-semibold text-zinc-800 mb-2">Integration Requirements</h3>
                <ul className="list-disc list-inside text-zinc-700 space-y-0.5 text-xs" role="list">
            ...
            {listing.complianceRequirements.length > 0 && (
              <div className="bg-zinc-50 rounded-lg border border-zinc-200 p-3">
                <h3 className="text-sm font-semibold text-zinc-800 mb-2">Compliance Requirements</h3>
