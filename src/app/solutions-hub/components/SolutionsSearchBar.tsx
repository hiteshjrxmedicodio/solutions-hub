      ...
      <div className="flex items-center gap-4 rounded-full border border-zinc-200 bg-zinc-50 px-5 py-4 shadow-[0_15px_40px_-20px_rgba(15,23,42,0.4)]">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-r from-blue-600 to-teal-600 text-white transition hover:from-blue-700 hover:to-teal-700"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
