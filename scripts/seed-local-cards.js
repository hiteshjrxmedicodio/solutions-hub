/**
 * Seed Solution Cards into Local MongoDB Database
 * Usage: node scripts/seed-local-cards.js
 */
...
async function seedDatabase() {
  try {
    ...
    console.log('📦 Seeding solution cards...');
    ...
    console.log(`✅ Successfully seeded ${result.length} solution cards!`);
